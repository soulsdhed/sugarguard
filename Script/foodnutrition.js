      ...
      for (let i of data) {
        ...
        const sugarPercent =
          i.total_sugars_g != null
            ...
            : "";
        const protein =
          i.protein_g != null ? Number(i.protein_g).toFixed(2) + "g" : "N/A";
        const proteinPercent =
          i.protein_g != null
            ? ((i.protein_g * 100) / 55).toFixed(2) + "%"
            : "";
        const fat = i.fat_g != null ? Number(i.fat_g).toFixed(2) + "g" : "N/A";
        const fatPercent =
          i.fat_g != null ? ((i.fat_g * 100) / 54).toFixed(2) + "%" : "";
        const saturatedFattyAcids =
          i.total_saturated_fatty_acids_g != null
            ? Number(i.total_saturated_fatty_acids_g).toFixed(2) + "g"
            : "N/A";
        const saturatedFattyAcidsPercent =
          i.total_saturated_fatty_acids_g != null
            ? ((i.total_saturated_fatty_acids_g * 100) / 15).toFixed(2) + "%"
            : "";
        ...
        const cholesterolPercent =
          i.cholesterol_mg != null
            ...
            : "";
        const sodium =
          i.sodium_mg != null ? Number(i.sodium_mg).toFixed(2) + "mg" : "N/A";
        const sodiumPercent =
          i.sodium_mg != null
